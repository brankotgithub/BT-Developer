...
?>
         <?php
            ...
            get_template_part('/template-parts/skillSection');
            get_template_part('/template-parts/projectSection');
            get_template_part('/template-parts/Aboutsection');
            get_template_part('/template-parts/newProject');
            get_template_part('/template-parts/clientSection');
         ?>   
